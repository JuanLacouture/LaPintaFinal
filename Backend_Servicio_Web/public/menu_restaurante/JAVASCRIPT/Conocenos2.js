function showInfo(person) {
    ...
    setTimeout(() => {
        if (person === 'juanjo') {
            logo.src = "/menu_restaurante/Imagenes/Conocenos2/juanjoConocenos - copia.png";            
            ...
            logo.src = "/menu_restaurante/Imagenes/Conocenos2/lacuConocenos - copia.png";
            ...
            logo.src = "/menu_restaurante/Imagenes/Conocenos2/andresConocenos - copia.png";
...
function resetInfo() {
    ...
    setTimeout(() => {
        logo.src = "/menu_restaurante/Imagenes/Conocenos/Logo.png";
